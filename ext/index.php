...
<html>
    <head>
        ...
        <title>Sistema de Acreditaci&oacute;n - Ingreso al Sistema</title>
    ...
    <body id="login">
        ...
        <div id="wrapper">
            <div id="content">
                <div id="header">
                    <h1><a href=""><img src="resources/images/logodta.png" alt="Sistema de Acreditaci&oacute;n" width="120px"></a></h1>
                    <span class="title2">Sistema de <br>Acreditaci&oacute;n</span>
                </div>
                <div id="darkbanner" class="banner380">
                    <h2>Ingreso</h2>
                </div>
                ...
                <form name="login_form" method="post" action="#" id="login_form">
                    <fieldset class="form">
                        ...
                        <p>
                            <label for="contrasena_usuario">Contrase&ntilde;a:</label>
                            <input name="contrasena_usuario" id="password_usuario" type="password">
                        </p>
