Ext.define('ibmetrodta.controller.formularios.InfoEnsayo', {
    ...
    refs: [
        ...
        {
            ref: 'InfoEnsayoForm',
            selector: '[xtype=formularios.infoensayo.edit.infoensayoform]'
        },
        {
    ...
    init: function() {
        this.listen({
            ...
            component: {
                ...
                'grid[xtype=formularios.infoensayo.lista] button#descargaForm': {
                    click: this.descargaForm
                },
                'window[xtype=formularios.infoensayo.edit.infoensayowindow] button#save': {
                    click: this.save
                },
                'window[xtype=formularios.infoensayo.edit.infoensayowindow] button#cancel': {
                    click: this.close
                },
    ...
    descargaForm: function () {
        ...
        if (selected.length === 1)
        {
            ...
            obj = {
                url: ibmetrodta.app.globals.globalServerPath + 'reporte/pdfForm052',
                params: {
                    id_info_ensayo: data['id_info_ensayo']
                }
            };
    ...
    showSearch: function( button, e, eOpts ) {
        ...
        if( !win ) {
            win = Ext.widget( 'formularios.infoensayo.search.window', {
                title: 'Buscar Formulario FORM-052'
            });
        }
        // show window
        win.show();
    ...
    save: function(button, e, eOpts) {
        ...
        if ( form.isValid() )
        {
            ...
            if (record.dirty) {
                ...
                Ext.getBody().mask('Guardando Formulario FORM-052 ...');
                // if new record...
                if (record.phantom) {
    ...
    showEditWindow: function(record) {
        var me = this,
                win = me.getInfoEnsayoWindow2(),
                isNew = record.phantom;

        // if window exists, show it; otherwise, create new instance
        if (!win) {
            win = Ext.widget('formularios.infoensayo.edit.infoensayowindow', {
                title: isNew ? 'Añadir Formulario FORM-052' : 'Editar Formulario FORM-052'
            });
        }
