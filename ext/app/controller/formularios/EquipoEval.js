Ext.define('ibmetrodta.controller.formularios.EquipoEval', {
    ...
    refs: [
        ...
        },
        {
            ...
            selector: '[xtype=formularios.evaltecnica.edit.equipoevalwindow]'
        },
        {
            ref: 'EquipoEvalForm',
            selector: '[xtype=formularios.evaltecnica.edit.equipoevalform]'
        },
        {
    ...
    init: function() {
        this.listen({
            controller: {},
            component: {
                'grid[xtype=formularios.evaltecnica.equipoevallista]': {
                    beforerender: this.loadRecords,
                    itemdblclick: this.edit,
                    selectionchange: this.manejaBotones,
                    afterrender: this.manejaBotones
                },
                'grid[xtype=formularios.evaltecnica.equipoevallista] button#add': {
                    click: this.add
                },
                'grid[xtype=formularios.evaltecnica.equipoevallista] button#edit': {
                    click: this.edit
                },
                'grid[xtype=formularios.evaltecnica.equipoevallista] button#delete': {
                    click: this.remove
                },
                'window[xtype=formularios.evaltecnica.edit.equipoevalwindow] button#save': {
                    click: this.save
                },
                'window[xtype=formularios.evaltecnica.edit.equipoevalwindow] button#cancel': {
                    click: this.close
                }
            },
            global: {},
    ...
    add: function(button, e, eOpts) {
        var me = this,
            record = Ext.create('ibmetrodta.model.formularios.EquipoEval');
    ...
    remove: function() {
        ...
        else
        {
            ...
            else
            {
                Ext.Msg.confirm({
                    title: 'Atención',
                    msg: '¿Esta seguro que desea eliminar este Equipo?. Esta acción no puede ser deshecha.',
    ...
    showEditWindow: function(record) {
        ...
        if (!win) {
            win = Ext.widget('formularios.evaltecnica.edit.equipoevalwindow', {
                title: isNew ? 'Añadir Equipo' : 'Editar Equipo'
            });
        }
        // show window
        win.show();
