Ext.define('ibmetrodta.controller.formularios.ProveedorEval', {
    ...
    refs: [
        ...
        },
        {
            ...
            selector: '[xtype=formularios.evaltecnica.edit.proveedorevalwindow]'
        },
        {
            ref: 'ProveedorEvalForm',
            selector: '[xtype=formularios.evaltecnica.edit.proveedorevalform]'
        },
        {
    ...
    init: function() {
        this.listen({
            controller: {},
            component: {
                'grid[xtype=formularios.evaltecnica.proveedorevallista]': {
                    beforerender: this.loadRecords,
                    itemdblclick: this.edit,
                    selectionchange: this.manejaBotones,
                    afterrender: this.manejaBotones
                },
                'grid[xtype=formularios.evaltecnica.proveedorevallista] button#add': {
                    click: this.add
                },
                'grid[xtype=formularios.evaltecnica.proveedorevallista] button#edit': {
                    click: this.edit
                },
                'grid[xtype=formularios.evaltecnica.proveedorevallista] button#delete': {
                    click: this.remove
                },
                'window[xtype=formularios.evaltecnica.edit.proveedorevalwindow] button#save': {
                    click: this.save
                },
                'window[xtype=formularios.evaltecnica.edit.proveedorevalwindow] button#cancel': {
                    click: this.close
                }
            },
            global: {},
    ...
    add: function(button, e, eOpts) {
        var me = this,
            record = Ext.create('ibmetrodta.model.formularios.ProveedorEval');
    ...
    showEditWindow: function(record) {
        ...
        if (!win) {
            win = Ext.widget('formularios.evaltecnica.edit.proveedorevalwindow', {
