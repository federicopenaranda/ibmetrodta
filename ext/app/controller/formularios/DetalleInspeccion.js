Ext.define('ibmetrodta.controller.formularios.DetalleInspeccion', {
    ...
    refs: [
        ...
        },
        {
            ...
            selector: '[xtype=formularios.detalleinspeccion.edit.detalleinspeccionform]'
        },
        {
    ...
    init: function() {
        this.listen({
            ...
            component: {
                ...
                'grid[xtype=formularios.detalleinspeccion.lista] button#descargaForm': {
                    click: this.descargaForm
                },
                'window[xtype=formularios.detalleinspeccion.edit.detalleinspeccionwindow] button#save': {
                    click: this.save
                },
                'window[xtype=formularios.detalleinspeccion.edit.detalleinspeccionwindow] button#cancel': {
                    click: this.close
                },
    ...
    descargaForm: function () {
        ...
        if (selected.length === 1)
        {
            ...
            obj = {
                url: ibmetrodta.app.globals.globalServerPath + 'reporte/pdfForm056',
                params: {
                    id_detalle_inspeccion: data['id_detalle_inspeccion']
                }
            };
    ...
    showSearch: function( button, e, eOpts ) {
        ...
        if( !win ) {
            win = Ext.widget( 'formularios.detalleinspeccion.search.window', {
                title: 'Buscar Formulario FORM-056'
            });
        }
        // show window
        win.show();
    ...
    save: function(button, e, eOpts) {
        ...
        if ( form.isValid() )
        {
            ...
            if (record.dirty) {
                ...
                Ext.getBody().mask('Guardando Formulario FORM-056 ...');
                // if new record...
                if (record.phantom) {
    ...
    showEditWindow: function(record) {
        var me = this,
                win = me.getDetalleInspeccionWindow2(),
        ...
        // if window exists, show it; otherwise, create new instance
        if (!win) {
            win = Ext.widget('formularios.detalleinspeccion.edit.detalleinspeccionwindow', {
                title: isNew ? 'Añadir Formulario FORM-056' : 'Editar Formulario FORM-056'
            });
        }
