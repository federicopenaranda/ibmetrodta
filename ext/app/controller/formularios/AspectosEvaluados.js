Ext.define('ibmetrodta.controller.formularios.AspectosEvaluados', {
    ...
    refs: [
        ...
        },
        {
            ...
            selector: '[xtype=formularios.evaltecnica.edit.aspectosevaluadoswindow]'
        },
        {
            ref: 'AspectosEvaluadosForm',
            selector: '[xtype=formularios.evaltecnica.edit.aspectosevaluadosform]'
        },
        {
    ...
    init: function() {
        this.listen({
            controller: {},
            component: {
                'grid[xtype=formularios.evaltecnica.aspectosevaluadoslista]': {
                    beforerender: this.loadRecords,
                    itemdblclick: this.edit,
                    selectionchange: this.manejaBotones,
                    afterrender: this.manejaBotones
                },
                'grid[xtype=formularios.evaltecnica.aspectosevaluadoslista] button#add': {
                    click: this.add
                },
                'grid[xtype=formularios.evaltecnica.aspectosevaluadoslista] button#edit': {
                    click: this.edit
                },
                'grid[xtype=formularios.evaltecnica.aspectosevaluadoslista] button#delete': {
                    click: this.remove
                },
                'window[xtype=formularios.evaltecnica.edit.aspectosevaluadoswindow] button#save': {
                    click: this.save
                },
                'window[xtype=formularios.evaltecnica.edit.aspectosevaluadoswindow] button#cancel': {
                    click: this.close
                }
            },
            global: {},
    ...
    loadRecords: function(grid, eOpts) {
        ...
        var contEvalTecnica = me.getController('formularios.EvalTecnica');
    ...
    add: function(button, e, eOpts) {
        var me = this,
            record = Ext.create('ibmetrodta.model.formularios.AspectosEvaluados');
    ...
    remove: function() {
        ...
        else
        {
            ...
            else
            {
                Ext.Msg.confirm({
                    title: 'Atención',
                    msg: '¿Esta seguro que desea eliminar este Aspecto Evaluado?. Esta acción no puede ser deshecha.',
    ...
    showEditWindow: function(record) {
        ...
        if (!win) {
            win = Ext.widget('formularios.evaltecnica.edit.aspectosevaluadoswindow', {
                title: isNew ? 'Añadir Aspectos Evaluados' : 'Editar Aspectos Evaluados'
            });
        }
        // show window
        win.show();
