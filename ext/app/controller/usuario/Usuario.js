...
//////////////////////// menor o igual que tres //////////////////////////////////////
    ...
    save: function(button, e, eOpts) {
        var me = this,
                ...
                values = form.getValues(),
                callbacks, fieldUsuarioPassword1, fieldUsuarioPassword2, verPass;
        
        
        
        fieldUsuarioPassword1 = me.getUsuarioPassword1Form();
        fieldUsuarioPassword2 = me.getUsuarioPassword2Form();
        ...
        if ( form.isValid() && verPass )
        {
            ...
            for (var i = 0; i < arrayLength; i++) {
                if ( values['usuarioTipoUsuario000102s'][i] > 0 )
                {
                    ...
                    arrayUsuarioTipoUsuario.push(tmpUsuarioTipoUsuario);
                }
            }
            ...
            for (var i = 0; i < arrayLength; i++) {
                if ( values['usuarioProceso000102s'][i] > 0 )
                {
                    ...
                    arrayUsuarioProceso.push(tmpUsuarioProceso);
                }
            }
            ...
            for (var i = 0; i < arrayLength; i++) {
                if ( values['usuarioOec000102s'][i] > 0 )
                {
                    ...
                    arrayUsuarioOec.push(tmpUsuarioOec);
                }
            }
