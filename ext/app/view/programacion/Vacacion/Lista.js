Ext.define('ibmetrodta.view.programacion.Vacacion.Lista', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.programacion.vacacion.lista',
    title: 'Administrar Vacaciones',
    iconCls: 'icon_status',
    store: {type: 'programacion.vacacion'},
    minHeight: 450,
            ...
            columns: {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        dataIndex: 'fecha_inicio_vacacion',
                        renderer: Ext.util.Format.dateRenderer('Y-m-d')
                    },
                    {
                        text: 'Fecha de Fin',
                        dataIndex: 'fecha_fin_vacacion',
                        renderer: Ext.util.Format.dateRenderer('Y-m-d')
                    }
                ]
            },
