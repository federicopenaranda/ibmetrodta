Ext.define('ibmetrodta.view.proceso.PeticionArchivoPlanAccion.Lista', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.proceso.peticionarchivoplanaccion.lista',
    header: false,
    iconCls: 'icon_gear',
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        {
                            xtype: 'button',
                            //hidden: me.privilegio('peticionarchivoplanaccion.add'),
                            itemId: 'add',
                            iconCls: 'icon_add',
                            text: 'Añadir'
                        },
                        {
                            xtype: 'button',
                            hidden: true,   //me.privilegio('peticionarchivoplanaccion.edit'),
                            itemId: 'edit',
                            iconCls: 'icon_edit',
                            text: 'Editar'
                        },
                        {
                            xtype: 'button',
                            //hidden: me.privilegio('peticionarchivoplanaccion.delete'),
                            itemId: 'delete',
                            iconCls: 'icon_delete',
                            text: 'Eliminar'
                        }
