Ext.define('ibmetrodta.view.tramite.Tramite.edit.tab.Paso4', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.tramite.tramite.edit.tab.paso4',
    bodyPadding: 8,
    overflowY: 'auto',
    margin: -5,
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    xtype: 'label',
                    html: "<span class='titulo'>Paso 4 - Cotización de Apertura de Expediente.</span>"
                },
                {
                    xtype: 'label',
                    itemId: 'textEstado',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            html: 'a) Carga de Cotización de Apertura de Expediente (Personal DTA): ',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            html: 'b) Carga de Factura por pago de Cotización de Apertura de Expediente (Personal OEC): ',
                ...
                },
                {
                    ...
                    items: [
                         {
                            xtype: 'label',
                            html: 'c) Verificación de Factura por pago de Cotización de Apertura de Expediente (Personal DTA): ',
