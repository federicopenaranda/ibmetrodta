Ext.define('ibmetrodta.view.tramite.Tramite.edit.tab.Paso10', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.tramite.tramite.edit.tab.paso10',
    bodyPadding: 8,
    overflowY: 'auto',
    margin: -5,
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    xtype: 'label',
                    html: "<span class='titulo'>Paso 10 - Cotización de Evaluación.</span>"
                },
                {
                    xtype: 'label',
                    itemId: 'textEstado',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            html: 'a) Carga de Cotización de Evaluación (Personal DTA): ',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            html: 'b) Carga de Factura por pago de Cotización de Evaluación (Personal OEC): ',
                ...
                },
                {
                    ...
                    items: [
                         {
                            xtype: 'label',
                            html: 'c) Verificación de Factura por pago de Cotización por Evaluación (Personal DTA): ',
