Ext.define('ibmetrodta.view.tramite.Tramite.edit.tab.Paso7', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.tramite.tramite.edit.tab.paso7',
    bodyPadding: 8,
    overflowY: 'auto',
    margin: -5,
    initComponent: function() {
        ...
        Ext.applyIf(me, {
            items: [
                {
                    xtype: 'label',
                    html: "<span class='titulo'>Paso 7 - Cotización de Revisión Documental.</span>"
                },
                {
                    xtype: 'label',
                    itemId: 'textEstado',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            html: 'a) Carga de Cotización de Revisión Documental (Personal DTA): ',
                ...
                },
                {
                    ...
                    items: [
                        {
                            xtype: 'label',
                            html: 'b) Carga de Factura por pago de Cotización de Revisión Documental (Personal OEC): ',
                ...
                },
                {
                    ...
                    items: [
                         {
                            xtype: 'label',
                            html: 'c) Verificación de Factura por pago de Cotización de Revisión Documental (Personal DTA): ',
