Ext.define('ibmetrodta.view.tramite.Tramite.ListaConsejoPeticion', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.tramite.tramite.listaconsejopeticion',
                        ...
                        items: [
                            {
                                ...
                                handler: function (grid, rowIndex, colIndex) {
                                    me.fireEvent('itemapruebabuttonclick3',  grid, rowIndex, colIndex);
                                },
                            ...
                            },
                            {
                                ...
                                tooltip: 'Observar',
                                handler: function (grid, rowIndex, colIndex) {
                                    me.fireEvent('itemobservarbuttonclick3', grid, rowIndex, colIndex);
                                }/* ,
                                isDisabled: function (view, rowIndex, colIndex, item, record) {
                                    if ( parseInt(ibmetrodta.app.globals.globalIdUsuario) == parseInt(record.get('id_usuario')) )
                                    {
