Ext.define('ibmetrodta.view.formularios.AnexoConvenio.edit.AlcanceAcreditacionLab2Form', {
    extend: 'Ext.form.Panel',
    alias: 'widget.formularios.anexoconvenio.edit.alcanceacreditacionlab2form',
    requires: [
