Ext.define('ibmetrodta.view.usuario.UsuarioPrivilegio.Lista', {
            ...
            dockedItems: [
                {
                    ...
                    items: [
                        {
                            xtype: 'button',
                            //hidden: me.privilegio('usuario.usuarioprivilegio.add'),
                            itemId: 'add',
                            iconCls: 'icon_add',
                            text: 'Añadir'
                        },
                        {
                            xtype: 'button',
                            //hidden: me.privilegio('usuario.usuarioprivilegio.edit'),
                            itemId: 'edit',
                            iconCls: 'icon_edit',
                            text: 'Editar'
                        },
                        {
                            xtype: 'button',
                            //hidden: me.privilegio('usuario.usuarioprivilegio.delete'),
                            itemId: 'delete',
                            iconCls: 'icon_delete',
                            text: 'Eliminar'
                        }
