...
Ext.define('<?= $path;?>.view.<?= $modulo; ?>.<?= getNameTableSinCod($className); ?>.edit.<?= getNameTableSinCod($className); ?>Form', {
    extend: 'Ext.form.Panel',
    alias: 'widget.<?= strtolower($modulo); ?>.<?= strtolower(getNameTableSinCod($className)); ?>.edit.<?= strtolower(getNameTableSinCod($className)); ?>form',
    requires: [
