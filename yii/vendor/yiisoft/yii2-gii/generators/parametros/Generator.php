...
namespace yii\gii\generators\parametros;
...
class Generator extends \yii\gii\Generator
{
    ...
    {
        return 'Este generador genera las URLS respectivas a cada tabal de la base de datos.';
    }
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['db', 'ns', 'tableName', 'modelClass', 'baseClass','server'], 'filter', 'filter' => 'trim'],
    ...
    {
        return array_merge(parent::stickyAttributes(), ['ns', 'db', 'baseClass', 'generateRelations', 'generateLabelsFromComments','server']);
    }
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $listCod = divideCodigo($tableName);
