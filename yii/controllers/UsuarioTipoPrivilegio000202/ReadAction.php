		...
		if ($error == "") {
			try {
                ...
                if (isset($_GET['query']) && $_GET['query'] != "" && $condiQuery != "") {
                    $models = UsuarioTipoPrivilegio000202::find()
                    							->distinct(true)
												->with('fkIdUsuarioTipo','fkIdUsuarioPrivilegio')
												->asArray()
												->joinWith('fkIdUsuarioTipo')
												->joinWith('fkIdUsuarioPrivilegio')
												->where($condiQuery)
                                                ->all();
                    $total = sizeof($models);
					$models = UsuarioTipoPrivilegio000202::find()
											...
											for ($i=0; $i < sizeof($models); $i++) {
                            					...
                            					unset($models[$i]['fkIdUsuarioPrivilegio']);
											}
                    ...
                    if (isset($_GET['filter']) && $_GET['filter']!='') {
                        ...
                        foreach($filtros as $filtro):
                            ...
                            if (in_array($filtro['property'],$listManyMany)) {
                                ...
                                $listSubQuery[] = UsuarioTipoPrivilegio000202::find()
                                				->distinct(true)
                                                ->with('fkIdUsuarioTipo','fkIdUsuarioPrivilegio')
                                                ->asArray()
												->joinWith('fkIdUsuarioTipo')
