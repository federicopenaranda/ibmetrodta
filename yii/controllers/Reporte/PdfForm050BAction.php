 ...
 */
class PdfForm050BAction extends  Action
{
    public function run()
    {
		...
		$head = ['h1'=>utf8_encode('DIRECCIÓN TÉCNICA DE ACREDITACIÓN'),
				...
				'h3'=>utf8_encode('INFORME DEL PROCESO DE VIGILANCIA <br /> DE ACREDITACIÓN'),
				'h4'=>utf8_encode('DTA-FOR-050 B'),
				'h5'=>utf8_encode('2'),
    	...
    	$mpdf->WriteHTML($this->controller->renderPartial('pdfForm050A',array('respcot'=>$respcot),true));
