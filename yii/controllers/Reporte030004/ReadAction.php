...
namespace app\controllers\Reporte030004;
use yii\base\Action;
                    ...
                    if (isset($_GET['filter']) && $_GET['filter']!='') {
                        ...
                        foreach($filtros as $filtro):
                            ...
                            if (in_array($filtro['property'],$listManyMany)) {
                                ...
                                $listSubQuery[] = Reporte030004::find()
                                				->distinct(true)
                                                ->asArray()
                        ...
                        if ($sw == 0) {
                        	...
                        	$models = Reporte030004::find()
                            					->distinct(true)
                                                ->asArray()
                                                ->where(['IN','id_reporte',$listSubQuery[0]])
                                                ->andWhere(['IN','id_reporte',$listSubQuery[sizeof($listSubQuery)-1]])
                            					->all();
                            $total = sizeof($models);
                            $models = Reporte030004::find()
                            					->distinct(true)
