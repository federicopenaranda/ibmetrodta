                    ...
                    if (isset($_GET['filter']) && $_GET['filter']!='') {
                        ...
                        foreach($filtros as $filtro):
                            ...
                            if (in_array($filtro['property'],$listManyMany)) {
                                ...
                                $listSubQuery[] = EstadoTipo010604::find()
                                				->distinct(true)
                                                ->asArray()
                        ...
                        if ($sw == 0) {
                        	...
                        	$models = EstadoTipo010604::find()
                            					->distinct(true)
                                                ->asArray()
                                                ->where(['IN','id_estado_tipo',$listSubQuery[0]])
                                                ->andWhere(['IN','id_estado_tipo',$listSubQuery[sizeof($listSubQuery)-1]])
                            					->all();
                            $total = sizeof($models);
                            $models = EstadoTipo010604::find()
                            					->distinct(true)
