...
namespace app\controllers\PaqueteArticulo060101;

use yii\base\Action;
use app\models\PaqueteArticulo060101;
...
/**
 * Esta es la accion "create" para el controlador "PaqueteArticulo060101Controller".
 */
class CreateAction extends Action {
    ...
    public function run() {
        ...
        if ($error == "") {
            ...
            $model = new PaqueteArticulo060101();
                                        ...
                                        if ($record[$listObjRel]) {
                                            ...
                                            foreach ($record[$listObjRel] as $subCampo):
                                                ...
                                                foreach ($objRel->atributes() as $campo):
                                                    if ($campo != 'fk_id_articulo_almacen_egreso')
                                                    {
