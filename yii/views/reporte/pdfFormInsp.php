    ...
    <body>
        ...
        <div id="container" class="container">
            ...
            <div class="texto_central2">
                <strong> <?= $oec->fkIdOecTipo->codigo_oec_tipo; ?> de la <?= $oec->nombre_oec; ?> </strong><br>
                <?= $oec->departamento_oec; ?>-Bolivia
            </div>

            <div class="texto_central">
                la Acreditación como <strong><?= $tipoOecM ?></strong> de acuerdo a la Norma <strong>NB-ISO-IEC 17020:2012</strong> para realizar 
