Ext.define('ibmetrodta.controller.formularios.DetalleCertificacion', {
    ...
    refs: [
        ...
        },
        {
            ...
            selector: '[xtype=formularios.detallecertificacion.edit.form]'
        },
        {
...
//////////////////////// menor o igual que tres //////////////////////////////////////
    ...
    init: function() {
        this.listen({
            ...
            component: {
                ...
                'window[xtype=formularios.detallecertificacion.edit.window] button#save': {
                    click: this.save
                },
                'window[xtype=formularios.detallecertificacion.edit.window] button#cancel': {
                    click: this.close
                },
    ...
    showSearch: function( button, e, eOpts ) {
        ...
        if( !win ) {
            win = Ext.widget( 'formularios.detallecertificacion.search.window', {
                title: 'Buscar DetalleCertificacion'
            });
        }
        // show window
        win.show();
    ...
    save: function(button, e, eOpts) {
        ...
        if ( form.isValid() )
        {
            if ( me.boolDetalleCertificacionEdit === 0 && record.phantom )
            {
            }
            else
            {
            ...
            if (record.dirty) {
                ...
                Ext.getBody().mask('Guardando DetalleCertificacion ...');
                // if new record...
                if (record.phantom) {
    ...
    remove: function() {
        ...
        Ext.Msg.confirm({
            title: 'Atención',
            msg: '¿Esta seguro que desea eliminar esta DetalleCertificacion?. Esta acción no puede ser deshecha.',
    ...
    showEditWindow: function(record) {
        ...
        if (!win) {
            win = Ext.widget('formularios.detallecertificacion.edit.window', {
                title: isNew ? 'Añadir DetalleCertificacion' : 'Editar DetalleCertificacion'
            });
        }
        // show window
        win.show();
