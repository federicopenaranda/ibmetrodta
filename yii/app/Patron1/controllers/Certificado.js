Ext.define('ibmetrodta.controller.formularios.Certificado', {
    ...
    refs: [
        ...
        {
            ref: 'CertificadoForm',
            selector: '[xtype=formularios.certificado.edit.form]'
        },
        {
        ...
        {
            ref: 'CertificadoSearchWindow',
            selector: '[xtype=formularios.certificado.search.window]'
        },
        {
            ref: 'CertificadoSearchForm',
            selector: '[xtype=formularios.certificado.search.form]'
		}
//////////////////////// menor o igual que tres //////////////////////////////////////
    ...
    init: function() {
        this.listen({
            ...
            component: {
                ...
                'window[xtype=formularios.certificado.edit.window] button#save': {
                    click: this.save
                },
                'window[xtype=formularios.certificado.edit.window] button#cancel': {
                    click: this.close
                },
                'grid[xtype=formularios.certificado.lista] button#buscar': {
                    click: this.showSearch
                },
                'grid[xtype=formularios.certificado.lista] menuitem#clear': {
                    click: this.clearSearch
                },
                'window[xtype=formularios.certificado.search.window] button#search': {
                    click: this.search
                },
                'window[xtype=formularios.certificado.search.window] button#cancel': {
                    click: this.close
                }
            },
            global: {},
    ...
    save: function(button, e, eOpts) {
        ...
        if ( form.isValid() )
        {
            if ( me.boolCertificadoEdit === 0 && record.phantom )
            {
            }
            else
            {
    ...
    remove: function() {
        ...
        Ext.Msg.confirm({
            title: 'Atención',
            msg: '¿Esta seguro que desea eliminar esta Certificado?. Esta acción no puede ser deshecha.',
