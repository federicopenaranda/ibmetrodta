...
//////////////////////// menor o igual que tres //////////////////////////////////////
    ...
    save: function(button, e, eOpts) {
        ...
        if ( form.isValid() )
        {
            ...
            var arrayLength = values['usuarioTipoPrivilegio000202s'].length;

            for (var i = 0; i < arrayLength; i++) {
                if ( values['usuarioTipoPrivilegio000202s'][i] > 0 )
                {
                    var tmpUsuarioTipoPrivilegio = {
                        fk_id_usuario_privilegio: values['usuarioTipoPrivilegio000202s'][i]
                    };
                    arrayUsuarioTipoPrivilegio.push(tmpUsuarioTipoPrivilegio); // push this to the array
                }
            }

            values['usuarioTipoPrivilegio000202s'] = Ext.encode(arrayUsuarioTipoPrivilegio);
