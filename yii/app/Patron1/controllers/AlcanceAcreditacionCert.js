    ...
    remove: function() {
        ...
        else
        {
            ...
            else
            {
                Ext.Msg.confirm({
                    title: 'Atención',
                    msg: '¿Esta seguro que desea eliminar este alcanceacreditacioncert?. Esta acción no puede ser deshecha.',
    ...
    showEditWindow: function(record) {
        ...
        if (!win) {
            win = Ext.widget('evaluacion.evaluacion.edit.alcanceacreditacioncertwindow', {
                title: isNew ? 'Añadir AlcanceAcreditacionCert' : 'Editar AlcanceAcreditacionCert'
            });
        }
        // show window
        win.show();
